...
from roma.models.matcher import ConvRefiner, CosKernel, Decoder, GP, RegressionMatcher
from roma.models.transformer import Block, MemEffAttention, TransformerDecoder
...
def get_model(pretrained_backbone=True, resolution="medium", **kwargs):
    ...
    proj = nn.ModuleDict({"16": proj16, "8": proj8, "4": proj4, "2": proj2, "1": proj1})
