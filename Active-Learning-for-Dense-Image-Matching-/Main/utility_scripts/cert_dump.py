...
class CertDumpConfig:
    ...
    cand_npy: str | None = "/home/abhiram001/active_learning/abhiram/AMD_ab/datasets/cross_modality/Optical-Depth/train_idx.npy"
    ...
    ckpts: tuple[CheckpointConfig, ...] = field(
        default_factory=lambda: (
            CheckpointConfig(
                name="cycle0",
                path="/projects/_hdd/roma/Optical-Depth/Optical-Depth_Preseed/Optical-Depth_Preseed_cycle0_best.pth",
            ),
            CheckpointConfig(
                name="cycle1",
                path="/projects/_hdd/roma/Optical-Depth/Optical-Depth_random/Optical-Depth_random_cycle0_best.pth",
            ),
            CheckpointConfig(
                name="cycle2",
                path="/projects/_hdd/roma/Optical-Depth/Optical-Depth_random/Optical-Depth_random_cycle1_best.pth",
            ),
        )
    )
